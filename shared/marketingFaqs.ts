/** FAQ blocks for /pricing — used in UI and FAQPage JSON-LD (must stay identical). */
export const PRICING_MARKETING_FAQ = [
  {
...
/** FAQ blocks for /oral-boards-coach — used in UI and FAQPage JSON-LD (must stay identical). */
export const ORAL_BOARDS_MARKETING_FAQ = [
  {
