...
Multi-filament suture. Braided, less memory, higher knot security, higher tensile strength. More likely to saw through tissue, harbor infection than monofilament.
...
Tx: intralesional injection (mild cases). 5-FU: similar efficacy, less hypopigmentation than steroids. MOA: decreases fibroblast proliferation and collagen synthesis.
Tx: surgery (moderate, severe cases). Excision + steroid injection: 15% recurrence. Excision + XRT: 14% recurrence. Start XRT within 24 hours of excision, 2-3 sessions. Recurrence: male, age <29, size >5cm, associated skin graft.
...
Chronic: Fibrosis of soft tissues, decreased microvascular supply to skin. Limited ability to undermine or advance local tissues. Use regional or free tissue reconstructions out of zone of XRT injury.
...
Staging:  I: transient erythema, self-resolves. II: dermis. III: subcutaneous to muscle fascia. IV: below muscle fascia, exposed bone.
...
Tx: flap coverage. Ischial: Posterior thigh musculocutaneous (paraplegic patients), posterior thigh fasciocutaneous (ambulatory patients), biceps femoris VY, gluteal, gracilis flaps. Sacral: Gluteal flap, VY advancement. Trochanteric: Tensor fascia lata myocutaneous flap (allows readvancement).
Complications: Recurrence (50-70%). RF: hyperglycemia/uncontrolled diabetes (#1), osteomyelitis, paraplegic, age >70, immobility, poor nutrition, low BMI, anemia, ESRD, CVA, hip fracture. Re-advance previous flaps when possible.`,
...
Gain length by rearranging width. 30 degrees: 25% gain in length. 45 degrees: 50%. 60 degrees: 75%. 75 degrees: 100%. 90 degrees: 125%.
...
## Neck
Submental fasciocutaneous flap. Vascular: submental artery off cervical branch of facial artery. Traverses level I lymph nodes in neck. Use in intra-oral and lower face soft-tissue reconstruction.

## Trunk
Latissimus dorsi muscle/musculocutaneous flap. Vascular: thoracodorsal artery. Function: shoulder adduction, extension, internal rotation. Donor site has decreased shoulder range of motion that improves by one year. Versatile flap used mostly in breast reconstruction and trunk reconstruction; is the largest single muscle available for free flap.
Trapezius flap. Vascular: transverse cervical artery. Used in cervical-spine reconstruction.
Scapula bone flap. Vascular: circumflex scapular artery off subscapular artery. Traverses triangular space (teres minor, teres major, long head of triceps). Tip of scapula, can be chimeric flap with other tissues from subscapular system (latissimus dorsi, parascapular flaps). Used for shoulder, back of neck, axilla reconstruction.
Paraspinous flap. Type IV segmental blood supply. Used in spinal coverage.
Omentum flap. Vascular: right and left gastroepiploic arteries (only need one side). Used in sternal reconstruction, lymphatic surgery; needs subsequent skin coverage.
Lumbar artery perforator flap. Vascular: L4 lumbar artery perforator. Runs between erector spinae and quadratus lumborum. Innervation: cluneal nerve. Used as a secondary breast free flap option.
Groin flap. Vascular: superficial circumflex iliac artery. Used as a distant (non-microsurgical) flap for hand coverage.
Superficial circumflex iliac perforator. Thin, pliable flap; improved donor morbidity compared to radial forearm flap.
Iliac crest osteocutaneous flap. Vascular: deep circumflex iliac. Used as an alternative bone flap in mandibular reconstruction; better vertical height than fibula.

## Upper Extremity
Lateral arm flap. Vascular: posterior radial collateral artery. Runs between lateral triceps and brachialis. Used in forearm and hand reconstruction as a thin fasciocutaneous free flap.
Reverse lateral arm flap. Vascular: radial recurrent artery. Used for elbow coverage as a pedicled flap.
Radial forearm flap. Vascular: radial artery. Need normal Allen's test (intact palmar arch). Thin, pliable fasciocutaneous flap; can be innervated flap using lateral antebrachial cutaneous nerve. Used as pedicled (anterograde) for elbow coverage, reversed for hand coverage (to level of proximal interphalangeal joints), or free flap for head and neck reconstruction (e.g., hemiglossectomy defects), phalloplasty.
Ulnar artery flap. Vascular: ulnar artery. Less tendon exposure risk than radial forearm flap. Shorter pedicle, smaller diameter vessel than radial forearm flap.
Posterior interosseous artery flap. Vascular: pedicle between 5th/6th extensor compartments. Can be reversed and inset as distally as level of metacarpophalangeal joints.
Reverse homodigital island flap. Vascular: retrograde from contralateral digital artery with crossing vessel proximal to distal interphalangeal joint. Used for finger-tip injuries, sensate flap.

## Lower Extremity
Anterolateral thigh flap. Vascular: lateral descending circumflex artery. Passes through lateral inguinal ligament. Donor site morbidity: weak knee extension. Used as pedicled or free flap, fasciocutaneous or musculocutaneous flap. Can cover large defects: up to 35x25cm; can be innervated using lateral femoral cutaneous nerve.
Profunda artery perforator flap. Vascular: pedicle traverses through adductor magnus. Includes posteromedial thigh with superior border at gluteal crease. Used as secondary breast free flap option; favorable donor site, supine positioning.
Posterior thigh fasciocutaneous flap. Vascular: inferior gluteal artery descending branch.
Medial femoral condyle/trochlea bone/periosteal flap. Vascular: descending geniculate artery. Passes posterior to vastus medialis and anterior to adductor. Can be used for defects up to 7cm. Used in scaphoid nonunion surgery.
Gracilis flap. Vascular: medial circumflex artery. Travels between adductor magnus and adductor longus. Pedicle enters muscle laterally. Innervation: obturator nerve. Can be used as a free functional muscle flap, pedicled for perineal defects.
Rectus femoris flap. Vascular: descending branch of the lateral femoral circumflex artery. Function: hip flexion, knee extension. Used in groin coverage.
Gastrocnemius flap. Vascular: sural arteries. Used in upper 1/3rd tibia, knee wounds.
Medial sural artery perforator. Vascular: perforators can be traced to the popliteal artery. Thin, pliable fasciocutaneous flap.
Soleus flap. Vascular: proximal from posterior tibial, distal from peroneal.
Fibula bone flap. Vascular: peroneal artery. Anterior approach between extensor hallucis longus and interosseous septum, pedicle between flexor hallucis longus (FHL) and posterior tibial muscles. Skin island based on perforator from distal 1/3rd of the leg. Donor morbidity: decreased great toe flexion strength (due to harvest of flexor hallucis longus). Used for large bony defects, mandibular reconstruction; thick cortical bone stock. Up to 20cm of bone stock available; can perform multiple osteotomies. Preserve 5-6cm proximal and distal aspect of fibula. Can be performed with previous distal fibula fracture.
Reverse sural artery flap. Vascular: peroneal artery perforators artery, lesser saphenous vein. Used as a reversed pedicled flap for heel defects. MC cause flap loss: venous insufficiency. Improve with surgical delay: Incise flap to produce ischemia-induced hyperplasia and hypertrophy of blood vessels; complete elevation/inset of flap 2-3 weeks later.
Posterior tibial artery perforator propeller flap. Vascular: perforators from between soleus and flexor digitorum longus. Used as a regional option for lower extremity.

## Foot
Medial plantar artery flap. Vascular: continuation from posterior tibial artery. Perforator between flexor hallucis brevis and abductor hallucis muscles. Innervation: medial plantar nerve from tibial nerve. Used in heel reconstruction.
...
## Skin grafts
Three phases of initial healing, occur over first 5-6 days. Plasmatic imbibition: graft survives off nutrients from wound bed. Inosculation: new capillaries form. Revascularization: new blood vessels form.
Split-thickness grafts:  Less primary contracture (20% compared to 40% for FTSG), more secondary contraction than full-thickness grafts. Secondary contraction is inversely related to amount of dermis. Meshing, fascial placement increases secondary contraction. Lower metabolic demand than full-thickness grafts.
...
## Dermal substitutes
Dermal regenerative matrix template. Can be used over less vascularized wound beds. Requires debrided wound, no infection. Increase in matrix take with NWPT as bolster. Perform skin graft 3 weeks after placement.
...
## Fascial grafts
Tensor fascia lata.
Temporoparietal fascia. MC complication: alopecia.

## Bone grafts
Bone healing:  Osteogenesis: formation of new bone by cells. Osteoinduction: differentiate cells to bone healing (e.g., bone morphogenic protein [BMP]). Osteoconduction: vessels grow into mechanical scaffold (e.g., hydroxyapatite).
Bone flaps/vascularized bone graft. Osteogenesis: osteoblasts.
Bone grafts. Cancellous: osteoinduction. Cortical: osteoconduction. Bone cortical allografts have greater mechanical strength than cancellous autograft.`,
    
    'microsurgery': `# Free Flap

## Complications
MC microsurgical problem: venous congestion. Dx: fast capillary refill, purple flap color. RF: <2mm venous coupler. Hand-sewn anastomosis for smaller veins to reduce risk. Tx: prompt return to OR.
MC cause acute flap loss: arterial thrombosis. White clot: platelet aggregation, often from technical problem. Dx: ischemia of flap, pale, cool, no capillary refill. Tx: revise anastomosis, local heparin.

## Flap salvage
Highest likelihood of salvage with prompt return to OR (1st 48 hours). Mechanical causes (e.g., vessel kinking) favorable to thrombosis.
...
Near-infrared spectroscopy. Measures tissue oxygen saturation (arterial and venous components). Shown to improve deep inferior epigastric (DIEP) flap breast reconstruction salvage rate compared to clinical monitoring due to earlier detection of microvascular problems.

# Hypercoagulable States

Virchow's triad: vessel injury, venous stasis, hypercoagulable state. RF: personal history of DVT/PE, family history. Risk persists for several weeks after operation.
Inherited disorders. Factor V Leiden (MC genetic cause). Resistance to activated protein C. Others: antiphospholipid syndrome, antithrombin deficiency.
...
## Fibrinolytics
tPA (e.g., alteplase). Activate plasminogen to plasmin (degrades clot). Use for fibrinolysis of microsurgical arterial thrombosis. Inject locally into flap via artery, allow to drain out a flap vein that is not anastomosed. Associated with reduced fat necrosis, not associated with increased salvage in DIEP flaps.
...
Lidocaine: Blocks sympathetic response in vessels. No evidence supports one topical vasodilator better than another.`,
    
    'trunk': `# Chest

## Sternal wound infections
Arnold classification. Acute: 0-2 weeks. Subacute: 2-4 weeks, often with mediastinitis. Chronic: >4 weeks often with osteomyelitis.
Dx: CT scan, antibiotics (Abx), assess for mediastinitis.
Tx: debridement, flap coverage. Pectoralis major advancement flaps. Pectoralis major turnover flap: alternative for dead space, inferior defects. Need to know if internal mammary arteries (IMA) were used during cardiac bypass; can only perform if IMA is intact. Alternatives: Pedicled rectus abdominus (need intact IMA), Omentum for sizable defects, dead space obliteration.

## Pectus excavatum
Dx: sunken anterior chest and sternum.
Tx: chest wall reconstruction at age 6-12 if symptomatic. Skeletal correction: Nuss external support bars, thoracoscopic retrosternal support bars. Soft-tissue correction: custom silicone elastomer; augmentation mammaplasty.
...
Rohrich grading. I: Minimal hypertrophy. II: Moderate hypertrophy. III: Severe hypertrophy with mild ptosis. IV: Severe hypertrophy, severe ptosis.
Tx: liposuction.
...
Anatomy. Arcuate line: area below umbilicus that demarcates where the posterior sheath ends (formed by internal oblique and transversalis fascia); there is no defined posterior sheath inferior to this line. Innervation of abdominal muscles: Transversalis abdominus plane (TAP) - nerve runs between transversus abdominus and internal oblique muscles (from intercostal nerves).
Tx: Prehabilitation: botulinum toxin injection to lateral musculature increases likelihood of primary closure of hernias.
Anterior components separation. Incise fascia lateral to semilunar line. Excursion of 4cm to upper abdomen, 8cm mid abdomen, 3cm suprapubic (per side).
Posterior components separation. Release of transversus abdominus (TAR) medial to semilunar line.
Mesh usage. Reduces recurrence compared to tissue repair. Mesh options: Synthetic (better strength, cheaper), Biologic (potentially more resilient with infection/GI spillage and considered for high-risk, contaminated cases). Retrorectus position: lowest complication and recurrence rate. Other mesh placements: intraperitoneal, onlay (over fascia). Bridge repair when unable to approximate fascia; highest recurrence risk compared to other mesh repairs.
Complications: Abdominal compartment syndrome. Increased compartment pressure causes diaphragm elevation, vascular compression, organ compression. Dx: clinical exam, elevated bladder pressure (>20), peak inspiratory pressure (>30) on ventilator. Tx: decompressive laparotomy.

## Congenital abdominal-wall diseases
Omphalocele. Midline, partial-thickness defect with intestines covered by a membrane. Commonly associated with a chromosome abnormality (e.g., trisomy 13).
Gastroschisis. Right of umbilical cord, full-thickness defect with no intestinal coverage. Dx: elevated AFP (maternal). Tx: direct closure +/- components separation, abdominal silo if large. Silo protects viscera, allows progressive reduction.
...
Post-oncologic defects. Abdominoperineal resection (~50%) and pelvic exenteration (80%) have high complication rate with primary closure. Commonly had neoadjuvant XRT to perineum. Tx: vertical rectus abdominus musculocutaneous (VRAM), pedicled ALT, pedicled PAP flaps, gracilis (higher complication rate).
Vaginal reconstruction. Agenesis associated with many conditions:  Mayer Rokitansky Küster Hauser syndrome: 46XX with Müllerian duct aplasia, associated with renal, cardiac, hearing abnormalities; intact ovarian function, secondary-sex characteristics. Partial and complete androgen insensitivity syndromes: 46XY, no development of male genitals, phenotypically female. Tx: internal pudendal flaps; Complication: stenosis (manage with serial dilation). Posterior defects: VRAM. Anterior and lateral defects: Superficial perineal artery (pudendal thigh) flap - maintains sensation (pudendal nerve). Total defects: Bilateral gracilis muscle flaps. Rectovaginal fistula. Control source/inflammation with diverting ostomy then staged reconstruction. Tx: gracilis muscle flap.

## Spine reconstruction
Spine wound dehiscence. Risk for cerebrospinal fluid leak if dura exposed. Tx: vascularized tissue over dural repair (use local fascia, muscle flaps with skin coverage).
Myelomeningocele. Congenital malformation of spine with outpouching of spinal cord at birth. Due to failure of neural tube closure during 4th week of gestation. Associated with folic acid deficiency. Dx: high AFP, neonatal ultrasound. Presence of hydrocephalus distinguishes from meningocele. Can be associated with cardiac, renal, orthopaedic, other neurologic abnormalities. Tx: antibiotics, neurosurgery to shunt, repair dura; prompt reconstruction/coverage of spine with local flaps (<48 hours due to risk of meningitis). RF for tethered cord syndrome.

# Gender Surgery

## Head/neck
Facial feminization. Dx: Ousterhout classification (MC type 3 80%). Tx: frontal sinus setback, burring supraorbital ridge, hairline reduction, brow lift.
Chondrolaryngoplasty. Addresses thyroid cartilage. Complication: anterior commissure tendon injury. Sx: decreased voice pitch without hoarseness.

## Chest ("top") surgery
WPATH guidelines: Adult (>18 years old), one mental health letter of support; Hormones not needed but recommended >1 year.
Masculinizing. Periareolar mastectomy for small breast volume, no ptosis. Mastectomy with free nipple graft for ptosis.
...
Feminizing. Tx: estrogen. DVT risk: highest with oral ethinyl estradiol, lowest with transdermal estradiol. Penetrative options: penile-inversion vaginoplasty, intestinal vaginoplasty. Penile-inversion vaginoplasty: Dissect in retroprostatic fascia (Denonvillier's); MC complication: neovaginal stenosis.
Masculinizing. Tx: testosterone. Lowers voice, increases muscle mass, increases body hair, cessation of menses: effects take 6 months to 5 years. Menses can return after d/c medication, other changes remain. Tx: surgical. Metoidioplasty: Uses local tissue to create neophallus. Phalloplasty: Radial forearm free flap (MC complication: urethral strictures, urethral fistulas); Osteocutaneous flaps (does not require prosthesis for erection); Innervated flaps: ilioinguinal nerve for tactile sensation, dorsal clitoral nerve for erogenous sensation. Urethral reconstruction: MC complication urethral stricture (highest with skin graft prelamination).
Penile replantation/transplantation. Dominant artery: deep dorsal penis artery. Skin also supplied by inferior external pudendal artery.`,
...
RF: xeroderma pigmentosum. X-linked recessive gene impairing nucleotide excision repair. Dx: extreme sun sensitivity, extensive photoaging, dry skin.
...
Tx: Moh's excision. Involves real-time circumferential skin lesion sectioning with frozen section review. Associated with high cure rate (>95% for basal and squamous cell carcinomas).
...
Actinic keratosis: ~10% malignant risk. Tx: cryotherapy, imiquimod (acts on skin immune system), topical 5-FU.
...
Lentigo maligna: melanoma in situ variant. Tx: excision, XRT, topical imiquimod (upregulates immunomodulation).
...
Radial forearm flap. Vascular: radial artery. Need normal Allen's test (intact palmar arch). Thin, pliable fasciocutaneous flap; can be innervated flap using lateral antebrachial cutaneous nerve. Used as pedicled (anterograde) for elbow coverage, reversed for hand coverage (to level of proximal interphalangeal joints), or free flap for head and neck reconstruction (e.g., hemiglossectomy defects), phalloplasty.
Ulnar artery flap. Vascular: ulnar artery. Less tendon exposure risk than radial forearm flap. Shorter pedicle, smaller diameter vessel than radial forearm flap.
Posterior interosseous artery flap. Vascular: posterior interosseous artery. Runs between extensor digiti minimi and extensor carpi ulnaris. Used for hand and elbow coverage; pedicle length limits free flap use.

## Lower Extremity
Medial sural artery perforator flap. Vascular: medial sural artery perforator. Used for heel coverage, Achilles coverage.
Sural artery flap. Vascular: lesser saphenous vein and sural nerve. Used for heel and Achilles coverage; pedicled flap.
Fibula bone flap. Vascular: peroneal artery. Segmental bone flap. Skin paddle: posterior/lateral leg. Used in mandibular reconstruction; donor site has increased ankle fracture risk.
Anterolateral thigh flap. Vascular: descending branch of lateral circumflex femoral artery. Innervation: lateral femoral cutaneous nerve. Muscle perforator or septocutaneous. Versatile flap with long pedicle, large donor site. Used in head and neck reconstruction, trunk reconstruction, extremity coverage.
Profunda artery perforator flap. Vascular: 1st or 2nd perforator of profunda femoris artery. Innervation: posterior femoral cutaneous nerve. Used in perineal reconstruction, breast reconstruction; disadvantage is prone position for flap harvest.
Gracilis flap. Vascular: medial circumflex femoral artery. Used in perineal reconstruction, breast reconstruction, functional muscle transfer.
Tensor fascia lata flap. Vascular: ascending branch of lateral circumflex femoral artery. Used in trochanteric coverage, abdominal-wall defects.
Rectus femoris flap. Vascular: descending branch of lateral circumflex femoral artery. Used for pelvic and groin coverage.`
  },
...
## Finger dislocations
Proximal interphalangeal (PIPJ) joint dislocation. Simple: reduce. Complex: unable to reduce due to interposed soft tissue. Dorsal (MC): interposed volar plate. Volar: interposed extensor tendon. Dx: Elson test to assess central slip integrity.
Metacarpophalangeal (MCP) joint dislocations. Rare, often complex due to volar plate interposition. Tx: surgical. Volar: higher risk of digital nerve injury. Dorsal: unable to repair volar plate.
...
Simple, stable (<30% joint surface). Dx: assess stability of joint with up to 30 degrees of PIPJ flexion. Tx: extension-block splinting or pinning (maintain in slight flexion).
...
Hook nail: soft tissue defect from loss of distal sterile matrix, inadequate bone/soft tissue support for nail. Tx: release scar with soft-tissue augmentation, excision of distal sterile matrix.
Nail ridging from untreated nail bed injury: Tx: attempt direct closure of nail bed at re-repair.

## Fingertip Injuries
Secondary intention healing for <1.5cm, no exposed bone. Tx: moist wound healing, petroleum jelly. Better sensation than flaps or skin grafts; associated with longer healing time.
...
## Brachial plexus
Upper roots (C5-7) proximal functions (shoulder function, elbow flexion). Sx: shoulder adducted/internally rotated, elbow extended, forearm pronated, fingers flexed.
...
Dx: clinical or electrodiagnostic testing. Nerve conduction studies: median nerve sensory peak latency >3.5ms, motor >4.5ms. Dx: US or MRI with increased cross-sectional area of median nerve. Dx: amyloidosis (~10% of bilateral carpal tunnel); congo red stain on tenosynovium biopsy.
Tx: night splinting (mild), corticosteroid injection for short-term relief.
Tx surgical: carpal tunnel release for symptoms >3 months, failure of conservative measures. No difference between open and endoscopic approaches long-term.
...
Tx: splinting, rest.
Tx surgery: release fascia between brachioradialis and extensor carpi radialis longus (ECRL). Pierces ECRL at 8cm proximal to radial styloid.
...
## Zone II
Tx surgery: repair within 2 weeks. Strength of repair related to # of core strands, suture size, locking suture, suture location (should be dorsal). 1cm bites optimal suture distance for repair. Repair of one FDS associated with decreased tendon resistance compared to both FDS slips.
...
Tx: 2-stage reconstruction. Stage 1: place silicone rod from DIPJ to central palm or distal forearm, allow capsule to recreate pulley system for 12 weeks. Stage 2: exchange silicone rod for tendon autograft.
...
Stenosing tenosynovitis (trigger finger). Flexed posture of digit, usually able to manually reduce. RF: diabetes. Tx: steroid injection. Tx: A1 pulley release if recurrent, advanced disease. Wait 12 weeks after steroid injection before surgery.

### A2 pulley
Arises from bone.
50% of pulley needed to prevent tendon bowstringing.
Closed rupture of pulley. Associated with rock climbing positions. Tx: rest, ice, ring splint. Tx: tendon autograft pulley reconstruction.
...
## Exam
Central slip (extensor zone III) injury. Main tendon for PIPJ extension. Dx: Elson test: cannot actively extend DIPJ in flexed MCPJ and PIPJ position with intact central slip due to lateral bands (but can extend PIPJ due to intrinsics). Tx: PIPJ extension splinting for 4-6 weeks or surgical repair.
...
Acute/subacute mallet finger (extensor zone I). Tx: splint in extension x 6-8 weeks. Tx: pin DIPJ in extension if unable to tolerate splint or volar subluxation of distal phalanx.
...
Tx surgery:  Distal pole: cast x 6-12 weeks or surgery for displacement, faster return to activities. Waist and proximal pole: consider screw fixation. Retrograde blood supply, proximal pole most prone to nonunion. Scaphoid nonunion advanced collapse (SNAC): arthritic pattern from scaphoid nonunion. Tx: scaphoidectomy and 4-corner fusion vs proximal row carpectomy.

## Hamate
Hook of hamate fracture. Sx: ulnar nerve symptoms, pain, flexor tendon injuries (decreased grip strength). MC tendon rupture: small finger flexor. Dx: XR (carpal tunnel view), CT scan.

## Wrist ligament injuries

### Scapholunate ligament injuries
Scapholunate advanced collapse (SLAC) arthritic pattern. Starts as a dorsal intersegmental instability (DISI) deformity; scaphoid flexes, lunate extends. Arthritis develops proximal row then midcarpal (radioscaphoid, scaphocapitate, capitolunate, then radiolunate). Dx: XR with scapholunate gap >3mm, scapholunate angle >70 degrees on lateral, contralateral side with clenched fist view (axial loading of wrist). Dx: arthroscopy (most accurate). Tx: scaphoidectomy and four-corner fusion or proximal row carpectomy.
...
## Chronic
Volkmann ischemic contracture. Affects deep volar compartment 1st. Tx: occupational therapy. Tx: surgical: tendon lengthening (mild), flexor pronator slide (moderate), superficialis to profundus (severe), free functional muscle transfer (severe).
...
Dx: XR. Eaton classification: symptoms don't correlate with imaging. I: joint space narrowing. II: small osteophytes. III: large osteophytes. IV: collapse changes: scapho-trapezoid-trapezium (STT) joint. Eaton stress view: thumbs pushed together, assess laxity/subluxation. Roberts view: hyperpronated thumb to evaluate trapeziometacarpal joint.
Tx: trapeziectomy. Ligament reconstruction with tendon interposition (LRTI) commonly performed; associated with higher complication rate than trapeziectomy alone. Thumb metacarpophalangeal joint (MCPJ) hyperextends to compensate for advanced collapse; need to correct >30 degrees MCPJ hyperextension. Tx: MCPJ fusion.
...
Tx: antibiotics; incision and drainage, loosely close wounds. 1st line: Amoxicillin/clavulanic acid. 2nd line (PCN allergy): clindamycin, TMP/SMZ. 3rd line: fluoroquinolones, doxycycline.
...
Tx: surgical release. Dorsal flap for webspace, full-thickness skin grafts for digits. Perform at 1 year of age. Release one webspace at a time.
...
Tibial: gastrocnemius, soleus, plantaris, popliteus, flexor digitorum longus, flexor hallucis longus (FHL). Dx: plantarflexion, sensation to plantar surface of the foot.
Femoral: anterior thighs muscles. Dx: leg extension.
Obturator: medial thigh muscles. Dx: thigh adduction.
Peroneal nerve: lateral and anterior compartments. Associated with proximal tibiofibular joint dislocation. Dx: absent dorsiflexion of the foot, sensation to lateral foot. Tx: nerve repair, nerve grafting, nerve transfer FHL (tibial nerve) to AT if severe injury.
Medial plantar nerve. Continuation of the tibial nerve.

## Lower extremity muscles
Superficial posterior: gastrocnemius and soleus. Dx: plantarflexion.
Deep posterior: toe flexors. Dx: FHL with flexion of great toe.
Anterior: anterior tibial, toe extenders. Dx: dorsiflexion, inversion.
Lateral: peroneus muscles. Dx: ankle eversion.
...
## Flaps
Pedicled. Propeller. Identify subcutaneous perforator to island of skin. MC failure due to venous congestion from kinking.
...
## Lower extremity
Peripheral arterial disease. Claudication that progresses from rest pain to tissue loss. Dx: palpate pulses, Doppler exam. Dx: ankle-brachial index. >1: normal. 0.7-0.9: claudication. <0.5: rest pain, tissue loss. Dx: toe-brachial index for non-compressible vessels (diabetes mellitus).
Venous insufficiency ulcers. Tx: elevate, serial compression dressings (Unna boot).
Lymphedema. MC cause obesity (U.S.), filiarsis infection (worldwide). Dx: Staging:  0: clinically normal, identified on lymphoscintigraphy. 1: clinically apparent, improves with limb elevation. 2: pitting edema, does not improve with elevation. 3: fibrosis of soft tissues.
Neuropathic foot ulcers. Treat non-infected, non-ischemic ulcers with contact casting. Tx: granulocyte-stimulating factor use associated with decreased need for below-knee amputation. Tx: medical honey draws fluid from deep to superficial by osmosis. Tx: hyberbaric oxygen indicated for exposed bone.
...
**Capsular contracture**. Baker grading:  I: Normal. II: Palpable. III: Visible. IV: Painful. MC cause: biofilm. Subclinical infection associated with indwelling medical devices. Forms due to extracellular polymeric substance matrix causing a surface for bacterial adherence. Slow bacterial growth rate reduces antibiotic efficacy. Reduced risk with IMF incision, subpectoral placement, and textured implants. No evidence to support extended antibiotic courses to prevent.
**Double capsule**. RF: OCPs. Sx: painless enlargement, becomes firm years after implantation.
**Double bubble**. Two transverse creases at lower pole of breast due to incomplete scoring or release of former IMF when lowering it with an implant. RF: superiorly displaced native IMF. Tx: release superficial fascial attachments to skin.
**Snoopy nose deformity**. Gland descends, implant stays in place. Tx: mastopexy.
**Animation deformity**. Tx: change from subpectoral to subglandular plane, +/- acellular dermal matrix or mesh.
**Rupture**. Dx: MRI.
**Galactocele**: milk-filled cyst caused by lactiferous duct blockage.
**Pneumothorax**. Sx: shortness of breath, chest tightness. Dx: chest xray.
**Infection**. Atypical mycobacterial infections. More common with cosmetic tourism. Doesn't respond to antibiotics, causes non-healing wounds. Dx: acid-fast stain and mycobacterial culture. Tx: remove implant, debride.
**Breast-implant-associated-ALCL (BIA-ALCL)**: See chapter 3: breast reconstruction.
**Breast implant illness**. Sx: vague systemic symptoms (fatigue, brain fog, headaches, anxiety). Dx: clinical diagnosis, no definitive laboratory or imaging test, consider work up for autoimmune disease. Tx: explantation (widely variable outcomes reported). +/- capsulectomy: studies don't show a difference in outcomes. Worse outcomes when known autoimmune disease.`,
...
### Pedicle Selection
**Inferior pedicle**. MC used. Maintains inferior blood supply and sensation. Better for large reductions. Can accommodate up to 1500g resection.
...
### Incision Patterns
**Wise pattern (anchor/inverted T)**. MC used. Better for larger reductions. Visible scar in IMF.
...
### Complications
**Nipple necrosis**. RF: smoking, diabetes, large reduction, tension. Tx: local wound care, observation for demarcation.
**Fat necrosis**. Firm mass, oil cysts. Dx: mammography, ultrasound. Tx: observation, excision if symptomatic.
**Infection**. Tx: antibiotics, drainage if abscess.
**Hematoma**. Early: <24 hours, evacuation needed. Late: observation.
**Wound dehiscence**. MC at T-junction. Tx: local wound care, secondary closure if needed.
**Hypertrophic scarring**. Tx: silicone, steroids, revision.
...
**Nipple-sparing mastectomy**. Preserves nipple-areola complex and breast skin. Relative indications: no ptosis, tumor <5cm, tumor >1cm from nipple, no multi-centric disease. Contraindications: axillary disease, lymphovascular invasion, HER2/neu (H2N)+ on pathology. Nipple necrosis rate associated with incision. Lateral inframammary is lowest, periareolar is highest.
**Contralateral prophylactic mastectomy**. Indications: genetic predisposition, high family risk, patient preference. Increases overall surgical risks compared to unilateral mastectomy.
**Breast-conserving therapy (partial mastectomy [lumpectomy]/XRT)**. Removal of mass with margins, generally with adjuvant XRT. Contraindications: multi-centric disease, diffuse calcifications on imaging, history of chest radiation, current pregnancy. Reconstruction after breast-conserving therapy not covered by all insurers.
...
### Complications
**Post-mastectomy XRT effects on implant**. MC cause of explantation. Increases capsular contracture (#1 risk factor), seroma, wound-healing problems, infections. Implant/TE exposure in setting of XRT: explant device in OR.
**RF for salvage failure**: deep infection (#1), XRT, obesity, seroma, diabetes mellitus.
**Infected tissue expander, implant**. MC organism: staph aureus (overall), MC gram negative: pseudomonas. Breast implant funnels decrease risk of bacterial contamination.
**Mastectomy skin necrosis**. Tx: nitroglycerin ointment initially.
**Breast-implant-associated ALCL (BIA-ALCL)**. RF: history of textured implant (or tissue expander). Contralateral side affected 5% of cases. Sx: delayed seroma. Dx: ultrasound, fine-needle aspiration for cytology. Fluid cytometry: CD30+, ALK-. Wright-Giemsa stain. MC bacteria: ralstonia. Tx: bilateral explantation (risk of contralateral involvement ~5%), total capsulectomy, oncology referral.
**Cyanoacrylate contact dermatitis**. 10-15% incidence, erythema limited to area of incision. Type IV immune response (T-cell mediated to foreign agent). Tx: remove offending agent, topical steroids.
**Post-mastectomy pain syndrome**. Sx: unilateral chest wall, axilla, upper arm pain from intercostobrachial nerve. Tx: gabapentin.
...
Complications:  Abdominal bulge, hernia: lower than TRAM but still possible. Fat necrosis: peripheral zones III and IV at risk. Flap loss: <5%. Donor site seroma.
...
**Many non-aesthetic indications**: migraines, hemifacial dyskinesia, blepharospasm, cervical dystonia, post-stroke upper limb spasticity, urinary problems, etc. **Hyperhidrosis**. Sx: bilateral symmetrical sweating, occurs >6 months, onset <25 years, occurs >1 week. Tx: ~50 units/axilla.
**Complications**. LD50 (lethal dose for 50% of patients): ~3000 units for a 70kg patient. Eyelid ptosis occurs due to spread to levator palpebrae superioris. Tx: apraclonidine (alpha-adrenergic agonist) eye gtts (acts on Muller's muscle).
Unknown use in pregnancy.

### Hyaluronic Acid Fillers
**Characteristics**. G' (modulus): higher value increases stiffness of product.
**Complications**. **Acute arterial compromise/tissue necrosis**. RF: glabella, nasolabial area near ala. Sx: skin discoloration, worsening pain. Tx: inject hyaluronidase. **Blindness**. Intra-vascular occlusion of central retinal artery. Due to embolism from dorsal nasal artery to internal carotid. Tx: immediate retrobulbar injection of hyaluronidase (within 60 minutes).
...
**Intermediate**:
**TCA**. Reaches upper (papillary) dermis. Endpoint: white frosting. Complication: hyperpigmentation. RF: higher Fitzpatrick skin types (IV, V, VI). Tx: hydroquinone.
...
### Laser
**CO2, Erbium ablative lasers** MC for skin resurfacing. Chromophore: water (erbium has higher affinity). Prophylaxis with antiviral for HSV due to risk of reactivation. Pretreat for post-inflammatory hyperpigmentation in higher Fitzpatrick skin types (>IV). Tx: hydroquinone. MOA: blocks conversion of tyrosine to dihydroxyphenylalanine to decrease melanin production. **Complications**:  Hypertrophic scarring. Decrease fluence (energy density), smaller treatment area, avoiding multiple passes. Need to be off isotretinoin for >6 months to reduce risk of abnormal scarring. Hyperpigmentation.
...
**Complications**:
**Hematoma**. RF: hypertension, male. Tx: blood-pressure control with clonidine.
**Skin loss**. Tx: observe, let demarcate, heal by secondary intention.
**Nerve injuries**. Often self-resolve. Immediate post-operative changes MC from local injection. In clinic, usually nerve injuries are a neuropraxia. Tx: observe for up to 6 months. Highest risk area: sub-SMAS near lateral malar eminence.
**Marginal mandibular nerve injury**. Innervates depressor labii inferioris, depressor anguli oris, mentalis. Location: deep to platysma and superficial to the facial vein. Dx: unable to evert lower lip, purse lips, whistle.
**Cervical branch**. Dx: lower teeth less visible with full smile on affected side.
...
Three lobes: anterior, intermediate, and posterior. Parotid duct passes through anterior lobe (posterior portion).
...
Tx: spreader grafts or auto spreader flaps. Increase radius of internal nasal valve.
...
### Horizontal Laxity
Slant from medial to lateral canthus. Can become negative (downward slanting) with age. Tx: canthopexy or canthoplasty.

### Malar Vector
Relationship of globe to malar soft tissues. Can become negative over time from deficient lid support. RF for lid ectropion. Tx: canthopexy or canthoplasty.
...
**Sjogren's syndrome**. Sx: dry eyes, dry mouth, polyarthritis. Dx: anti-SSA and anti-SSB serum test.
...
### Direct Closure
Can directly close up to 1/3 upper eyelid, 2/3 lower eyelid with lateral canthotomy. Tx: pentagonal excision and closure.

### Lamella
**Anterior**: skin. Can be skin grafts, flaps (e.g., Tripier). Post-burn contracture. Tx: contracture release, skin grafting.
...
**Complications**:
**Lower lid malposition**. MC: horizontal laxity of tarsoligamentous sling. Dx: snap-back test (distract 8mm). Tx: tarsal strip.
**Injury to inferior oblique**, divides medial/central fat compartments. Sx: elevate, abduct the eye.
**Retrobulbar hematoma**. Sx: pain, diminished visual acuity (decreased perception of red light initially), bruising, proptosis, decreased ocular movements. Tx: immediate lateral canthotomy, STAT ophthalmology consult, then mannitol, furosemide and then OR for orbital decompression.
**Chemosis**. Prolapse of conjunctiva. Tx: lubrication, eye patching. Tx: conjunctivotomy for severe or refractory.
...
**Complication**: fat embolism, generally within 72 hours from surgery. Sx: shortness of breath, confusion, petechial rash. Tx: cardiopulmonary support.
...
Complications:  MC: transient hypoesthesia. Paradoxical adipose hyperplasia. Abnormal focal increase in subcutaneous fat within treatment area. RF: large applicator, male, Hispanic, abdominal site. Tx: observe for 6 months, liposuction.
...
### Complications
**Hematoma**: MC complication. RF: male.
...
### Labiaplasty
**Complications**:  Hematoma. RF: male.
...
**Local anesthetic toxicity**. Lidocaine maximum dose: 7mg/kg with epinephrine, 4mg/kg plain. Can be higher (35-55mg/kg) as wetting solution in liposuction. Sx: lip numbness, metallic taste, slurred speech, nausea, anxiety, disorientation. Can progress to cardiac problems. Tx: secure airway first if unstable, fat emulsion (intra lipid) bolus then infusion.
...
Corticosteroid-related wound healing deficiency with use >30 days. Increased wound-healing complicated by 2-3x, impedes all phases of wound healing. Tx: vitamin A (oral).
...
Tx: discontinue agent, supportive care, dantrolene. Can use propofol for future anesthesia.
...
**Opioid abuse**. RF: younger age, bone procedures, psychiatric comorbidities, substance use history, and chronic pain history.
...
### Diabetes insipidus
Elevated serum sodium after head injury. MOA: vasopressin via posterior pituitary.
...
**Ventricular dysrhythmias**. Tx: compressions, automated defibrillator.
**Pulseless electrical activity**. Tx: compressions, epinephrine.
...
### Acute kidney injury
Dx: fractional excretion of sodium (FeNa) for etiology. Formula: (urine sodium x plasma creatinine) / (plasma sodium x urine creatinine). <1%: pre renal (hypovolemia or decreased perfusion). 1-3%: renal (MC acute tubular necrosis). >3%: post-renal (obstruction).
...
Tx: blood cultures, early antibiotics (within 1 hour of presentation when suspected), volume resuscitation, pressors, supportive care. Can trend lactate levels to assess resuscitation.
...
**Isosulfane blue allergy**. Dye used in sentinel lymph node biopsies. 1-3% of population have allergy. Tx: pressors.
...
### Bleeding diseases
**Von Willebrand**: MC congenital bleeding disorder. Abnormal factor VIII binding. Tx: DDAVP.`,
...
Tx: massive transfusion protocol. ~1:1 ratio of pRBC, FFP, avoid crystalloid.
...
**Complications**. Candidal mouth infection. Sx: white papules of oral mucosa. Tx: topical nystatin.

### Hand transplantation
Skin is the most immunogenic soft-tissue component.
Risk of reperfusion injury after transplantation. Dx: elevated potassium, CPK levels.
