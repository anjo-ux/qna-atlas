...
Histologically, it features increased type III collagen, involves myofibroblasts; parallel collagen organization.
...
Histologically, it features disorganized type I collagen; thick, randomly oriented collagen.
...
The staging system includes I transient erythema, self-resolves. II dermis. III subcutaneous to muscle fascia. IV below muscle fascia, exposed bone.
...
Complications include Recurrence (50-70%). RF hyperglycemia/uncontrolled diabetes (#1), osteomyelitis, paraplegic, age >70, immobility, poor nutrition, low BMI, anemia, ESRD, CVA, hip fracture. Re-advance previous flaps when possible.`,
...
Gain 25% gain in length. 45 degrees 50%. 60 degrees 75%. 75 degrees 100%. 90 degrees 125%.
...
## Skin grafts
There are three graft survives off nutrients from wound bed. Inosculation new capillaries form. Revascularization new blood vessels form.
Split-thickness grafts have Less primary contracture (20% compared to 40% for FTSG), more secondary contraction than full-thickness grafts. Secondary contraction is inversely related to amount of dermis. Meshing, fascial placement increases secondary contraction. Lower metabolic demand than full-thickness grafts.
A bolster with Negative-pressure wound therapy (NPWT) improves skin graft take over other bolster options.
The donor site has Moist dressings less painful (occlusive clear dressings, hydrocolloid), similar healing to other dressings.
...
## Tendon grafts
The donor site has palmaris longus, plantaris (longest length), extensor digitorum longus.

## Cartilage grafts
The donor site has septum, ear, rib (5-7).
The most common warping.
...
## Complications
The most common venous congestion. Dx fast capillary refill, purple flap color. RF <2mm venous coupler. Hand-sewn anastomosis for smaller veins to reduce risk. Tx prompt return to OR.
The most common arterial thrombosis. White clot platelet aggregation, often from technical problem. Dx ischemia of flap, pale, cool, no capillary refill. Tx revise anastomosis, local heparin.
...
Complications include Abdominal compartment syndrome. Increased compartment pressure causes diaphragm elevation, vascular compression, organ compression. Dx clinical exam, elevated bladder pressure (>20), peak inspiratory pressure (>30) on ventilator. Tx decompressive laparotomy.
...
Treatment involves MC for malrotation.
...
Complications include Abdominal bulge, hernia lower than TRAM but still possible. Fat necrosis peripheral zones III and IV at risk. Flap loss <5%. Donor site seroma.
...
Complications include MC transient hypoesthesia. Paradoxical adipose hyperplasia. Abnormal focal increase in subcutaneous fat within treatment area. RF large applicator, male, Hispanic, abdominal site. Tx observe for 6 months, liposuction.
